...
4. AI generates a structured Markdown handoff in the selected mode
5. Export runs according to the selected preset
6. Success or error state is shown in the popover
...
### Configure Pieces OS
1. Start Pieces OS
2. Enable `Use Pieces for Doom's Moment generation`
3. Test the connection from `Properties`
